		...
		<div class="container">
			<div class="row justify-content-center mb-5 pb-3"
				...
				<div class="col-md-20 heading-section ftco-animate"
					style="height: 60px;">
					<h2 class="mb-4" style="font-size: 35px; margin-top: 15px;">회원
						주문결제</h2>
				</div>
			</div>
			<!-- 타이틀 끝 -->
			...
			<form name="CheckOrder" action="order_03.jsp" method="post">
				<div class="order_list text-center">
					<table class="table">
						...
						<tbody>
							<tr>
								<th scope="col">${orderInfo.productName}</th>
								<th scope="col"></th>
								<th scope="col">${orderInfo.totalPrice}</th>
							</tr>
							<tr>
								<th scope="col"></th>
								<th scope="col"></th>
				...
				<div class="order_list">
					<table class="table">
						...
						<tbody>
							<tr>
								<th scope="col" style="padding-left: 40px"><a
									style="color: red; padding-right: 5px; write-space: nowrap;">*</a>이름</th>
								<th scope="col"><input type="text" name="user_name"></th>
							</tr>
							<tr>
								<th scope="col" style="padding-left: 40px"><br>
								<a style="color: red; padding-right: 5px; write-space: nowrap;">*</a>주소</th>
								<th scope="col"><input type="text" name="zipcode"
									id="sample6_postcode" readonly>&nbsp;&nbsp;&nbsp; <input
									type="button" onclick="sample6_execDaumPostcode()"
									value="우편번호 찾기">
									<p>
										<br> <input type="text" name="address1"
											id="sample6_address" readonly style="width: 325px">
							...
							<tr>
								...
								</select> - <input type="text" name="phone2" style="width: 80px">
									- <input type="text" name="phone3" style="width: 80px"></th>
							</tr>
						</tbody>
					</table>
				</div>
						...
						<tbody>
							...
							<tr>
								...
								<th scope="col"><input type="text" name="zipcode1"
									id="sample6_postcode1" readonly>&nbsp;&nbsp;&nbsp; <input
									type="button" onclick="sample6_execDaumPostcode1()"
									value="우편번호 찾기">
									<p>
										<br> <input type="text" name="address1_1"
											id="sample6_address_1" readonly style="width: 325px">
							...
							<tr>
								...
								<th scope="col"><select name="phone1_Sp" id="txtMobile1"
									style="width: 80px; height: 33px">
										...
										<option value="019">019</option>
										<option value="010">010</option>
								</select> - <input type="text" name="phone2_Sp" style="width: 80px">
									- <input type="text" name="phone3_Sp" style="width: 80px"></th>
							</tr>
							<tr>
								...
								<th scope="col"><select id="txtMobile1" name="phone1_Sp1"
									style="width: 80px; height: 33px">
										...
										<option value="019">019</option>
										<option value="010">010</option>
								</select> - <input type="text" name="phone2_Sp1" style="width: 80px">
									- <input type="text" name="phone3_Sp1" style="width: 80px"></th>
							</tr>
							<tr>
								<th scope="col"
									style="padding-left: 40px; padding-bottom: 50px;"><br>주문메세지<br>(100자내외)</th>
			...
			<div style="text-align: center">
				<button type="button" class="btn btn-secondary"
					onclick="Check_Order()">결제하기</button>
				&nbsp;&nbsp;
				<button type="button" class="btn btn-secondary"
					onclick="location.href='/cart'">취소하기</button>
			</div>
			<br> <br>
		</div>
	</section>
