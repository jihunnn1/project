					...
					<table
						...
						<tr>
							...
							<td colspan="3" class="email" style="padding-left: 10px;"><input
								type="text" name="email1" placeholder="" value=<%=memEmail[0]%>
								size="20"> @ <select name="email2" id="selcet1"
						...
						<tr>
							...
							<td colspan="3" class="phone" style="padding-left: 10px;"><select
								name="phone1" id="selcet1" style="height: 35px; width: 80px;">
									...
									<option value="010">010</option>
							</select>- <input type="text" name="phone2" value=<%=memPhoneNum[1]%>
								size="5">- <input type="text" name="phone3"
								value=<%=memPhoneNum[2]%> size="5"> <input type="button"
								name="phone_certification" value="핸드폰인증"></td>
						</tr>
						<tr>
							<td
								style="background-color: #212529; border-bottom: 1px solid white;"
							...
							<td colspan="3" class="addr" style="padding-left: 10px;"><input
								type="text" name="memAdr"  id="sample6_postcode"
								readonly size="15"> <input type="button" value="우편번호 찾기"
						...
						<tr>
							...
							<td colspan="3" class="addr1" style="padding-left: 10px;"><input
								type="text" id="sample6_address" name="memAdr1" size="40" value="">
								<div style="padding-top: 10px;">
									<input type="text" name="memAdr2" id="sample6_address2" size="40" value="">
								</div></td>
