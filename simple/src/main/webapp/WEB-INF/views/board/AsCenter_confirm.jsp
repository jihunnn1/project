...
function confirm() {
	...
	var form = document.asCenterConfirm;
	//아이디 검사 ---------------------------------------------------------------------------
	if (form.asCenterPwdConfirm.value == "") {
		alert("비밀번호를 입력해주세요!");
		form.asCenterPwdConfirm.focus();//포커스를 id박스로 이동.
		return false;
		...
		<div class="container">
			...
			<form  name="asCenterConfirm"
				...
				<div style="margin-bottom:100px;">
					...
					<input type="button" id="buttonmy" class="btn btn-dark" onclick="confirm()" value="확인"
						style="float: left; margin-left: 10px; margin-top: 49px; border-radius: 2px; font-size: 14px; padding-top: 4px; background-color: #7e9c8c; height:36px; border:none;">
					<button type="button"
